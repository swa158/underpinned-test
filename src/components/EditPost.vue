        ...
        <v-card>
          ...
          <v-form ref="form">
            ...
            <v-container>
                <v-row>
                <v-col cols="12">
                    <v-text-field label="Title" v-model="title" :rules="inputRules" name="title" value="title" required></v-text-field>
                </v-col>
                <v-col cols="12">
                    <v-textarea filled label="Enter description" v-model="description" :rules="inputRules" name="description" value="description" required></v-textarea>
                </v-col>
                </v-row>
            </v-container>
            </v-card-text>
